    ...
    try {
      const res = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: "New enquiry — Inbhear Mor Driving School",
          from_name: form.name,
          phone: form.phone,
          message: form.message,
          business: "Inbhear Mor Driving School",
        })
      })
        ...
        <div>
          ...
          <div className="flex flex-col gap-4 text-gray-700">
            <div className="flex items-center gap-3">
              ...
              <a href="tel:0872637116" className="font-bold text-lg hover:underline" style={{ color: "#FFC300" }}>087 263 7116</a>
            </div>
